...
export default function Page() {
    return (
        <main>
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <dl className="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-3">
                            <div className="mx-auto flex max-w-xs flex-col gap-y-4">
                                <dt className="text-base leading-7 tdark:text-white ext-gray-600">Transactions every 24 hours</dt>
                                <dd className="order-first text-3xl font-semibold tracking-tight text-gray-900 dark:text-white sm:text-5xl">44 million</dd>
                            </div>
                            <div className="mx-auto flex max-w-xs flex-col gap-y-4">
                                <dt className="text-base leading-7 dark:text-white text-gray-600">Assets under holding</dt>
                                <dd className="order-first text-3xl font-semibold tracking-tight text-gray-900 dark:text-white sm:text-5xl">$119 trillion</dd>
                            </div>
                            <div className="mx-auto flex max-w-xs flex-col gap-y-4">
                                <dt className="text-base leading-7 dark:text-white text-gray-600">New users annually</dt>
                ...
                <div className="bg-white py-24 sm:py-32 dark:bg-sky-950 rounded-lg">
                    <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
                        <div className="max-w-2xl">
                            ...
                            <p className="mt-6 text-lg leading-8 dark:text-yellow-200  text-gray-600">Libero fames augue nisl porttitor nisi, quis. Id ac elit odio vitae elementum enim vitae ullamcorper suspendisse.</p>
                        </div>
                        <ul role="list" className="grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-16 xl:col-span-2">
                            <li>
                                <div className="flex items-center gap-x-6">
                                    ...
                                    <div>
                                        <h3 className="text-base font-semibold leading-7 tracking-tight dark:text-white text-gray-900">Leslie Alexander</h3>
                                        <p className="text-sm font-semibold leading-6 dark:text-pink-600 text-indigo-600">Co-Founder / CEO</p>
                                    </div>
                                </div>
                            </li>
                            <li>
            ...
            <section className = "border-solid border-2 rounded-lg mt-6" >
                <div>
                    <div className=" object-left block p-4 mt-2 mb-2 bg-white dark:bg-sky-950 rounded-lg shadow w-72 h-full">
                ...
                <div className=''>
                    <div className="p-4 bg-white dark:bg-sky-950 mt-2 mb-2 rounded-lg shadow w-72">
                        <div>
